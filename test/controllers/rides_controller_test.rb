...
class RidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ride" do
    assert_difference("Ride.count") do
      post rides_url, params: { ride: { date: @ride.date, hours: @ride.hours, location: @ride.location, miles: @ride.miles } }
    end
  ...
  test "should update ride" do
    patch ride_url(@ride), params: { ride: { date: @ride.date, hours: @ride.hours, location: @ride.location, miles: @ride.miles } }
